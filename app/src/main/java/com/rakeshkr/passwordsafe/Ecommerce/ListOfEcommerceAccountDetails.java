...
public class ListOfEcommerceAccountDetails extends AppCompatActivity implements OnItemClickListener {
    ...
    String[] ecommerceAccountArrayKeyList,ecommerceAccountArrayValueList;

    Integer[] imgIdsList;
    Map<String,String> ecommerceAccounts = new HashMap<String,String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.bank_detail_id:
                        ...
                        myUtility.finishTask(ListOfEcommerceAccountDetails.this);
                        return true;
        ...
        ecommerceAccounts = ecommerceDataSource.getAllEmails();
        if (ecommerceAccounts.isEmpty()){
    ...
    private void setListView() {
        for(String key : ecommerceAccounts.keySet()){
            String value = ecommerceAccounts.get(key);
            valueList.add(value);
            keyList.add(key);
        }
        ecommerceAccountArrayKeyList=keyList.toArray(new String[keyList.size()]);
        ecommerceAccountArrayValueList=valueList.toArray(new String[valueList.size()]);

        imgIdsList=(ecommerceDataSource.getListOfImgageId(keyList)).toArray(new Integer[keyList.size()]);
        lView = (ListView) findViewById(R.id.list_of_social_ac);
        lviewAdapter = new ListViewAdapterForImage(this, ecommerceAccountArrayValueList, imgIdsList);
    ...
    public void onItemClick(AdapterView<?> adapterView, View arg1, int position, long id) {
        ...
        Intent viewIntent=new Intent(getApplicationContext(),DisplayIndividualEcommerceAccountDetails.class);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        menu.setHeaderTitle((String) ecommerceAccountArrayValueList[info.position]);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        String databaseId=(String)ecommerceAccountArrayKeyList[info.position];
        String title=(String)ecommerceAccountArrayValueList[info.position];
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.action_add_to_db:
                Intent addIntent=new Intent(getApplicationContext(),AddNewEcommerceDetail.class);
